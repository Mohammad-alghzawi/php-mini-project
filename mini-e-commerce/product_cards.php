...
echo '<br>';
echo '<br>';
echo "<a style='margin-left:20px;'href='tableproduct.php'><button style=' background-color:#ffe4c4a3; width: 120px; height:50px; border-radius:5px'>table product</button></a>";
